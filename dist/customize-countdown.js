(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["CustomizeCountdown"] = factory();
	else
		root["CustomizeCountdown"] = factory();
})(this, () => {
...
class Clock {
  constructor(options) {
    ...
    // 创建数字管结构
    const DIGIT_TUBE_TEMPLATE = '<div class="count-wrap">' + '<div class="dig-wrap"><div class="dig-item"></div><div class="dig-item"></div></div>' + '<div class="count-dot"></div>' + '<div class="dig-wrap"><div class="dig-item"></div><div class="dig-item"></div></div>' + '<div class="count-dot"></div>' + '<div class="dig-wrap"><div class="dig-item"></div><div class="dig-item"></div></div>' + '</div>';
...
// 导出Clock类
/* harmony default export */ const main = (Clock);
;// ./src/index.js
// 引入样式
